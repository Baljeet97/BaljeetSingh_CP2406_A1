    ...
    public static void main(String[] args) {
        ...
        while (car.getStartPointX() <= road1.endOfX() && car.getStartPointY() <= road1.endOfY()) {
            ...
            if (road1.getLengthOfRoad() == 2) {
                car.moveCar();
                System.out.println("Car is on Road: " + road1.getRoad() + "" + " Segment: " + car.getStartPointY() + " " + light.lightStatus);
            }
        }
        ...
        if (car.getStartPointY() == road2.getPositionAtY()) {
            ...
            while (car.getStartPointX() <= road2.endOfX() && car.getStartPointY() <= road2.endOfY()) {
                light.setState();
                car.moveCar();
                System.out.println("Car is on Road: " + road2.getRoad() + "" + " Segment: " + car.getStartPointY() + " " + light.lightStatus);
            }
